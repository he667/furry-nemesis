...
public class FruitsClockWidgetProvider extends AppWidgetProvider {
	...
	public void onDisabled(Context context) {
		...
		Intent intent = new Intent(context, FruitsClockBroadCastReceiver.class);
	...
	public void onEnabled(Context context) {
		...
		Log.d(FruitsClockActivity.TAG, "--- onEnabled");
	}
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
		...
		for (int widgetId : appWidgetManager.getAppWidgetIds(thisWidget)) {
			...
			Log.d(FruitsClockActivity.TAG, "--- onUpdate");
